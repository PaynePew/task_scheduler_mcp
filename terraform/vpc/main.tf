...
# S3 Gateway VPC Endpoint — free, routes S3 traffic through AWS backbone.
# Attached to private route table so ECR image-layer pulls avoid IGW for
# the blob portion (ECR stores layers in S3).
