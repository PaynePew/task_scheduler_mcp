...
from app.actions.llm_polish import LlmPolishHandler
from app.actions.llm_summarize import LlmSummarizeHandler
...
ACTION_REGISTRY: dict[str, ActionHandler] = {
    ...
    LlmSummarizeHandler.name: LlmSummarizeHandler(),
    LlmPolishHandler.name: LlmPolishHandler(),
}
